...
export class MyFlower extends CGFobject {
    constructor(scene, flowerRadius, nPetals, receptacleRadius, stemRadius, stemSize, posx = 5, posz = 5, yRotation = 0, petalTexture, receptacleTexture, stemTexture, leafTexture) {
        super(scene);
        this.scene = scene;
