    ...
    constructor(scene, matrixSize = 5) {
        ...
        for(var i = 0; i < matrixSize; i++){
            for(var j = 0; j < matrixSize; j++){
                ...
                this.flowers.push(new MyFlower(scene, flowerRadius, nPetals, receptacleRadius, stemRadius, stemSize, posx, posz, yRotation, this.petalTextures[petalColor], this.receptacleTexture, this.stemTextures[stemColor], this.leafTextures[leaveColor], i, j));
            }
        }
