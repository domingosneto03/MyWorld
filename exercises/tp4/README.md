In the first exercise we mapped the texture from "tangram.png" on every vertex of each polygon. The necessary partitions were created with the help of the auxiliar texture "tangram-lines.png". 
