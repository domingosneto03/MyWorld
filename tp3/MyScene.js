...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        // Red Wood (no ambient, low specular)
        this.material4 = new CGFappearance(this);
        const wood_spec = 5; // de 0 a 10
        this.material4.setAmbient(0.0, 0.0, 0.0, 1.0);
        this.material4.setDiffuse(139 / 256, 69 / 256, 19 / 256, 1.0);
        this.material4.setSpecular(139 / 2560 * wood_spec, 69 / 2560 * wood_spec, 19 / 2560 * wood_spec, 0.1);
